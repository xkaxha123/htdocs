		...
		<div id="content">
			<div class="sub_con">
				...
				<div class="right_con">	
                    ...
                    <div>
                        <form name="writeform" action="action.php" method="post" enctype="multipart/form-data"><br>
                            <strong>제목 </strong><input type ="text" name ="title" maxlength="30" style="width:616px; height:25px;"><br><br>
                            <strong>내용 </strong><textarea name ="content" cols ="100" rows ="10"></textarea><br><br>
                            <strong><label for="upload">첨부파일</label></strong>
                            <input type="file" name="upload" id="upload">
                            <input type ="submit" style="float:right;" value="저장"><br>
                        </form>
                    </div>
				</div>
			</div>	
