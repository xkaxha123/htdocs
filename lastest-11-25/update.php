				...
				<div class="right_con">	
                    ...
                    <div>
                        <form name="writeform" action="action.php" method="post"><br>
                            <strong>제목<input type="text" name="title" style="width:616px; height:25px;" value="<?= $result['title'] ?>"></strong><br><br>
                            <strong>내용<textarea name="content" cols ="100" rows ="10" ><?= $result['content'] ?></textarea></strong><br>
